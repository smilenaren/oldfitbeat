<?php
/*
Template Name: Studio Challenge
*/
/**
...
?>
	...
	?>
<main class="studio-challenge">
	<section class="slider__wrapper">
		<div class="layout-container">
			<div class="flex-container">
				<div class="slider__content">
					<h2>6 WEEK RECOVERY <span>CHALLENGE</span></h2>
					<h3>RECLAIM YOUR BODY!</h3>
					<ul>
						<li><span><i class="fas fa-check"></i></span> <div class="content">Workouts, nutrition & tracking all <span>personalised</span> to your fitness goal!</div></li>
				...
				<div class="video__content">
					<a class="link-holder no-link play-video" href="javascript:;" data-video="<?php echo get_template_directory_uri()?>/img/studio-challenge/6week-video.mp4">
						<img src="<?php echo get_template_directory_uri()?>/img/studio-challenge/video-image-resize.jpg" alt="Yianni" >
		...
		<div class="layout-container">
			<div class="main__content">
				...
				<div class="align-center fixed-item">
					<h4>DON'T MISS THIS LIMITED OFFER</h4>
					<div class="click">
					<a class="btn-color" href="<?php echo get_site_url();?>/form"><span>CLICK TO SEE IF YOU QUALIFY</span> <i class="fas fa-angle-right"></i></a>
					</div>
				...
				<ul>
					...
					<li><i class="fas fa-angle-right"></i> Personalised meal plans, recipes & shopping lists</li>
					<li><i class="fas fa-angle-right"></i> Home delivered meals personalised to your fitness goal (optional extra)</li>
					<li><i class="fas fa-angle-right"></i> Personalised progress tracking via your Fitbeat app</li>
					...
					<li><i class="fas fa-angle-right"></i> 3 pairs of hygienic gym gloves worth $30</li>
					<li><i class="fas fa-angle-right"></i> Expert personal trainers in every workout</li>
					<li><i class="fas fa-angle-right"></i> Unlimited classes</li>
					<li><i class="fas fa-angle-right"></i> 1-on-1 progress consultations</li>
					<li><i class="fas fa-angle-right"></i> Home Workout App with personalised workouts</li>
					<li><i class="fas fa-angle-right"></i> Flexible starting dates</li>
				</ul>
			</div>
		</div>
	</section><!--contentwrap-->
	...
	<section class="gymtour__wrapper align-center">
		<div class="layout-container">
			<div class="flex-container">
				<div class="gymtour__content">
					<a class="btn-color" href="<?php echo get_site_url();?>/form"><span>CLICK TO SEE IF YOU QUALIFY</span> <i class="fas fa-angle-right"></i></a>
					<h4>DON'T MISS THIS LIMITED OFFER</h4>
					<div class="time__wrap"><div class="clock-2"></div></div>
				</div>
				<div class="gymtour__video">
					...
					<a class="link-holder no-link play-video" href="javascript:;" data-video="<?php echo get_template_directory_uri()?>/img/studio-challenge/Fitbeat-Virtualtour.m4v">
						<img class="noheight" src="<?php echo get_template_directory_uri()?>/img/studio-challenge/group-video.jpg" alt="Yianni" >
						<span class="close video-close"></span>
						<div class="video-ajax"></div>
						<div class="icon-watch">
						<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
				...
				<div class="flex-container">
					...
					<div class="workout__wrap">
						...
						<div class="content__block">
							...
							<p>Track your progress to ensure that you achieve your fitness goal. Perform 3 body composition scans throughout your challenge, and wear your heart rate monitor during workouts. All results upload instantly to your Fitbeat app.</p>
						</div>
					</div><!--workout-->
				</div>
			</div>
		...
		<div class="layout-container scroll-fixed-wrap">
			...
			<div class="flex-container">
					<div class="testimonial__block">
						<div class="image__block">
							<img src="<?php echo get_template_directory_uri()?>/img/studio-challenge/tess-3124605.jpg" alt="">
						</div>
						<div class="content__block">
							<p>"I lost 7kg’s in 6 weeks. You have 1-on-1 catchups with your trainer, you get the body scans, you talk about your goals and your progress.  I’ve fallen in love with Fitbeat"</p>
							<h5>Tess K</h5>
						</div>
					</div><!--testimonial-->
					<div class="testimonial__block">
						<div class="image__block">
							<img src="<?php echo get_template_directory_uri()?>/img/studio-challenge/yianni-2958221.jpg" alt="">
						</div>
						<div class="content__block">
							<p>"I came to Fitbeat to change my momentum from always feeling like a skinny guy. Their personalised workouts helped me to bulk up in a surprisingly short time."</p>
							<h5>Yianni M</h5>
						</div>
					</div><!--testimonial-->
					<div class="testimonial__block">
						<div class="image__block">
							<img src="<?php echo get_template_directory_uri()?>/img/studio-challenge/mel-2958172.jpg" alt="">
						</div>
						<div class="content__block">
							<p>"When I started at Fitbeat I was pretty clueless and intimidated by all gyms. My goal was to gain muscle and get into shape. The trainers are great and I' definitely accomplished what I set out to do."</p>
							<h5>Mel G</h5>
						</div>
					</div><!--testimonial-->
				</div>
	...
	<section class="bodychallenge__wrapper align-center">
		<div class="layout-container">
				...
				<h2>6 WEEK RECOVERY CHALLENGE</h2>
				<a class="btn-color" href="<?php echo get_site_url();?>/form"><span>CLICK TO SEE IF YOU QUALIFY</span> <i class="fas fa-angle-right"></i></a>
