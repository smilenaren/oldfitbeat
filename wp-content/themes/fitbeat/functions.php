...
function fitbeat_scripts() {
	wp_enqueue_style( 'fitbeat-style', get_stylesheet_uri(), array(), '1.27', 'all' );
...
function cptui_register_my_cpts() {
	...
	/**
	 * Post Type: Heart Rate FAQ IOS.
	 */
	$labels = array(
		"name" => __( "Heart Rate Faq Ios", "custom-post-type-ui" ),
		"singular_name" => __( "Heart Rate Faq Ios", "custom-post-type-ui" ),
	);
	$args = array(
		"label" => __( "Heart Rate Faq Ios", "custom-post-type-ui" ),
		"labels" => $labels,
		"description" => "",
		"public" => true,
		"publicly_queryable" => true,
		...
		"hierarchical" => true,
		'menu_position'=> 53,
		"rewrite" => array( "slug" => "heart-faqios", "with_front" => true ),
		"query_var" => true,
		"supports" => array( "title", "editor", "thumbnail", "page-attributes" ),
	);
	register_post_type( "heart-faqios", $args );
		/**
	 * Post Type: Heart Rate FAQ Android.
	 */
	$labels = array(
		"name" => __( "Heart Rate Faq And", "custom-post-type-ui" ),
		"singular_name" => __( "Heart Rate Faq And", "custom-post-type-ui" ),
	);
	$args = array(
		"label" => __( "Heart Rate Faq And", "custom-post-type-ui" ),
		"labels" => $labels,
		"description" => "",
		"public" => true,
		"publicly_queryable" => true,
		...
		"hierarchical" => true,
		'menu_position'=> 52,
		"rewrite" => array( "slug" => "heart-faqand", "with_front" => true ),
		"query_var" => true,
		"supports" => array( "title", "editor", "thumbnail", "page-attributes" ),
	);
	register_post_type( "heart-faqand", $args );
		/**
	 * Post Type: Casting FAQ Ios.
	 */
	$labels = array(
		"name" => __( "Casting FAQ Ios", "custom-post-type-ui" ),
		"singular_name" => __( "Casting FAQ Ios", "custom-post-type-ui" ),
	);
	$args = array(
		"label" => __( "Casting FAQ Ios", "custom-post-type-ui" ),
		"labels" => $labels,
		"description" => "",
		"public" => true,
		"publicly_queryable" => true,
		...
		"hierarchical" => true,
		'menu_position'=> 55,
		"rewrite" => array( "slug" => "casting-faqios", "with_front" => true ),
		"query_var" => true,
		"supports" => array( "title", "editor", "thumbnail", "page-attributes" ),
	);
	register_post_type( "casting-faqios", $args );
		/**
	 * Post Type: Casting FAQ Android.
	 */
	$labels = array(
		"name" => __( "Casting FAQ And", "custom-post-type-ui" ),
		"singular_name" => __( "Casting FAQ And", "custom-post-type-ui" ),
	);
	$args = array(
		"label" => __( "Casting FAQ And", "custom-post-type-ui" ),
		"labels" => $labels,
		"description" => "",
		"public" => true,
		"publicly_queryable" => true,
		...
		"hierarchical" => true,
		'menu_position'=> 54,
		"rewrite" => array( "slug" => "casting-faqand", "with_front" => true ),
		"query_var" => true,
		"supports" => array( "title", "editor", "thumbnail", "page-attributes" ),
	);
	register_post_type( "casting-faqand", $args );
}
...
add_filter('single_template', function($template) {
	...
	if ( $queried->post_type === 'heart-faqios' ) { // only for this CPT
	  // file name per OP requirements
	  $file = 'single-heart-faqios-';
	...
	if ( $queried->post_type === 'heart-faqand' ) { // only for this CPT
		// file name per OP requirements
		$file = 'single-heart-faqand-';
		$file .= $queried->post_parent ? 'child' : 'parent';
		// using `locate_teplate` to be child theme friendly
		return locate_template("{$file}.php") ? : $template;
	  }
	  if ( $queried->post_type === 'casting-faqios' ) { // only for this CPT
		// file name per OP requirements
		$file = 'single-casting-faqios-';
		$file .= $queried->post_parent ? 'child' : 'parent';
		// using `locate_teplate` to be child theme friendly
		return locate_template("{$file}.php") ? : $template;
	  }
	  if ( $queried->post_type === 'casting-faqand' ) { // only for this CPT
		// file name per OP requirements
		$file = 'single-casting-faqand-';
		$file .= $queried->post_parent ? 'child' : 'parent';
		// using `locate_teplate` to be child theme friendly
		return locate_template("{$file}.php") ? : $template;
	  }
