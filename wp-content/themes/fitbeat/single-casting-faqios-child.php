  ...
  <?php get_header('faq'); ?>
      ...
      <?php if ( get_the_content()) : ?>
        <div class="flex-content">
         <div class="flex-col <?php if ( has_post_thumbnail() ) { echo "half-width"; } else {echo "full-width"; } ?>"><?php the_content();?></div>
         <?php if ( has_post_thumbnail() )  : ?>
         <div class="flex-col img-col"><?php the_post_thumbnail( 'medium' )?></div>
         <?php endif;?>
        </div>
      <?php endif;?>
    ...
    <?php while( have_rows('faq_content') ): the_row();
        ...
        <?php endif; ?>
            <div class="sub-menu faq-casting-wrap">
              <?php the_sub_field('casting_faq_content'); ?>
            </div>
        </li>
    <?php endwhile; ?>
    </ul>
