							...
							<div class="plan-item-list">
								...
								<?php if( have_rows('plan_item_repeater', $post_objects->ID) ): ?>
									...
									<?php if(get_sub_field('duration_type') == 'day') {
										...
										$duration = 'week';
									} elseif (get_sub_field('duration_type') == 'none') {
										$duration = 'none';
									} else {
										$duration = 'month';
									}									
										...
										<div class="plan-item-content <?php echo $header_class;?>">
											...
											?>
												...
												<div class="price">
													...
													<?php } ?>
													<span class="<?php echo $cut_class; ?>">$<?php the_sub_field('normal_price');?></span><?php if($duration!='none'):?> /<?php echo $duration; ?><?php endif; ?>
												</div>
												<?php endif ?>
												<?php if( $discount_price ) { ?>
												<div class="price">
