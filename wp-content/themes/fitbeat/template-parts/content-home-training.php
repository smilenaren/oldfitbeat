...
<section id="mainVideoBanner" class="video__banner">
	...
	<div class="item">
		<div class="promo__video">
			<video class="mobile-hide" poster="<?php echo get_template_directory_uri(); ?>/img/man-workout-lunge.png" class="promo__video-desktop" muted="" playsinline="" loop="" autoplay="" src="<?php echo get_template_directory_uri(); ?>/img/home-training/desktop-home-short.mp4">
			</video>
			...
			<div class="inner bg-overlay">
				...
				<div class="button-holder">
					<div class="flex-container">
						<a id="showVideoPopup" class="btn btn--primary btn--medium btn-white" href="<?php echo get_template_directory_uri(); ?>/img/home-training/desktop-home-video.m4v">Watch Video
					...
					<div class="grid-half grid-content">
						...
						<ul class="repeatable-list">
							...
							<li id="nutrition"><svg width="16px" height="21px" viewBox="0 0 12 15" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
								<path d="M6.92779e-13 2.67133e-12L7.5591 5.24357L15 2.67133e-12L15 6.56304L7.5 12L8.52651e-13 6.56304L6.92779e-13 2.67133e-12Z" transform="matrix(-4.371139E-08 -1 1 -4.371139E-08 0 15)" fill="#1A1B1B" stroke="none" />
							</svg> Cast to your smart TV and sync with your music device.<br>Invite friends and train together with built-in video calls</li>
						</ul>
					</div>
					<div class="grid-half">
					...
					<div class="grid-half grid-content">
						...
						<ul class="repeatable-list">
							...
							<li id="tracking"><svg width="16px" height="21px" viewBox="0 0 12 15" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
								<path d="M6.92779e-13 2.67133e-12L7.5591 5.24357L15 2.67133e-12L15 6.56304L7.5 12L8.52651e-13 6.56304L6.92779e-13 2.67133e-12Z" transform="matrix(-4.371139E-08 -1 1 -4.371139E-08 0 15)" fill="#1A1B1B" stroke="none" />
							</svg> Or purchase ready-made meals delivered to your door, all customised for your fitness goal.</li>
						</ul>
					</div>
					<div class="grid-half">
						<div class="image-gallery mobile-hide">
	...
	<div class="layout__container">
		...
		<div class="grid-block">
			<div class="flex-container justify-center">
				<?php /* <div class="grid-half" style="width:50%">
					<div class="border-box" style="display:block;">
						...
						<ul class="repeatable-list">
							...
							<li><svg width="9px" height="12px" viewBox="0 0 12 15" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
								<path d="M6.92779e-13 2.67133e-12L7.5591 5.24357L15 2.67133e-12L15 6.56304L7.5 12L8.52651e-13 6.56304L6.92779e-13 2.67133e-12Z" transform="matrix(-4.371139E-08 -1 1 -4.371139E-08 0 15)" fill="#1A1B1B" stroke="none" />
							</svg>Or purchase ready-made meals delivered to your door by My Muscle Chef</li>
							<li><svg width="9px" height="12px" viewBox="0 0 12 15" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
								<path d="M6.92779e-13 2.67133e-12L7.5591 5.24357L15 2.67133e-12L15 6.56304L7.5 12L8.52651e-13 6.56304L6.92779e-13 2.67133e-12Z" transform="matrix(-4.371139E-08 -1 1 -4.371139E-08 0 15)" fill="#1A1B1B" stroke="none" />
						...
						<div class="button-holder">
							<div class="flex-container item-btn">
								<a class="btn btn--primary btn--medium" href="https://app.fitbeat.com/web/auth/create-account">Join Now
									<svg width="22px" height="20px" viewBox="0 0 12 15" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
										<path d="M6.92779e-13 2.67133e-12L7.5591 5.24357L15 2.67133e-12L15 6.56304L7.5 12L8.52651e-13 6.56304L6.92779e-13 2.67133e-12Z" transform="matrix(-4.371139E-08 -1 1 -4.371139E-08 0 15)" fill="#1A1B1B" stroke="none" />
									</svg>
								</a>
				...
				<div class="grid-half">
					<div class="border-box padding-b-40">
						...
						<div class="prices">
							<div class="flex-container">
								<div class="item">
								<div class="price"><span><small id="dollar"></small><span id="price"></span></span> /month</div>
								</div>
								<!-- <div class="item">
									<span class="tag bg-overlay">Special Offer</span>
						...
						<ul class="repeatable-list">
							...
							<li><svg width="9px" height="12px" viewBox="0 0 12 15" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
								<path d="M6.92779e-13 2.67133e-12L7.5591 5.24357L15 2.67133e-12L15 6.56304L7.5 12L8.52651e-13 6.56304L6.92779e-13 2.67133e-12Z" transform="matrix(-4.371139E-08 -1 1 -4.371139E-08 0 15)" fill="#1A1B1B" stroke="none" />
							</svg>Or purchase ready-made meals delivered to your door</li>
							<li><svg width="9px" height="12px" viewBox="0 0 12 15" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
								<path d="M6.92779e-13 2.67133e-12L7.5591 5.24357L15 2.67133e-12L15 6.56304L7.5 12L8.52651e-13 6.56304L6.92779e-13 2.67133e-12Z" transform="matrix(-4.371139E-08 -1 1 -4.371139E-08 0 15)" fill="#1A1B1B" stroke="none" />
							</svg>Leading home workout app</li>
							<li><svg width="9px" height="12px" viewBox="0 0 12 15" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
								<path d="M6.92779e-13 2.67133e-12L7.5591 5.24357L15 2.67133e-12L15 6.56304L7.5 12L8.52651e-13 6.56304L6.92779e-13 2.67133e-12Z" transform="matrix(-4.371139E-08 -1 1 -4.371139E-08 0 15)" fill="#1A1B1B" stroke="none" />
							</svg>Cast workouts to your phone, tablet or compatible smart tv.<br>Invite friends and train together with built-in video calls</li>
							<li><svg width="9px" height="12px" viewBox="0 0 12 15" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
								<path d="M6.92779e-13 2.67133e-12L7.5591 5.24357L15 2.67133e-12L15 6.56304L7.5 12L8.52651e-13 6.56304L6.92779e-13 2.67133e-12Z" transform="matrix(-4.371139E-08 -1 1 -4.371139E-08 0 15)" fill="#1A1B1B" stroke="none" />
							</svg>Option in app to purchase Tigernovo heart rate monitor for $79 (normally $99) excluding delivery</li>
							<li><svg width="9px" height="12px" viewBox="0 0 12 15" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
								<path d="M6.92779e-13 2.67133e-12L7.5591 5.24357L15 2.67133e-12L15 6.56304L7.5 12L8.52651e-13 6.56304L6.92779e-13 2.67133e-12Z" transform="matrix(-4.371139E-08 -1 1 -4.371139E-08 0 15)" fill="#1A1B1B" stroke="none" />
							</svg>Cancel future payments at any time</li>
							<li><svg width="9px" height="12px" viewBox="0 0 12 15" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
								<path d="M6.92779e-13 2.67133e-12L7.5591 5.24357L15 2.67133e-12L15 6.56304L7.5 12L8.52651e-13 6.56304L6.92779e-13 2.67133e-12Z" transform="matrix(-4.371139E-08 -1 1 -4.371139E-08 0 15)" fill="#1A1B1B" stroke="none" />
						...
						<div class="button-holder position-static">
							...
							<a class="btn btn--primary btn--medium" id="plan-button" href="https://app.fitbeat.com/web/auth/create-account">Start free trial
									<svg width="22px" height="20px" viewBox="0 0 12 15" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
										<path d="M6.92779e-13 2.67133e-12L7.5591 5.24357L15 2.67133e-12L15 6.56304L7.5 12L8.52651e-13 6.56304L6.92779e-13 2.67133e-12Z" transform="matrix(-4.371139E-08 -1 1 -4.371139E-08 0 15)" fill="#1A1B1B" stroke="none" />
									</svg>
								</a>
...
<?php /*<section class="section discover-call bg-overlay">
	<div class="layout__container">
...
<script type="application/javascript">
	function geoip(json){
		var countrycode = document.getElementById("dollar");
		var price = document.getElementById("price");
		countrycode.textContent = json.country_code;
		var country_code = json.country_code;
		if (country_code == "AU") {
			countrycode.textContent = "AU";
			price.textContent = "$17.99";
			document.getElementById("plan-button").href = "https://app.fitbeat.com/web/AuthLoading?planId=price_1IQuC3GgqUDgVRX6ARJJZ2Kl&coupon=&onceoff=&accountType=Home";
		} else {
			countrycode.textContent = "US";
			price.textContent = "$12.99";
			document.getElementById("plan-button").href = "https://app.fitbeat.com/web/AuthLoading?planId=price_1IJHS5GgqUDgVRX6GOMWh4TY&coupon=&onceoff=&accountType=Home";
		}
	}
</script>
